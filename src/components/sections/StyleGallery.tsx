  ...
  return (
    <section className="section-padding bg-white">
      <div className="container mx-auto px-4">
        <StyleSection 
          styles={photographyStyles}
          title="Wedding Photography Styles"
          subtitle="Find the perfect photography style that matches your vision"
          icon={Camera}
        />
        <StyleSection 
          styles={videographyStyles}
          title="Wedding Videography Styles"
          subtitle="Discover the ideal videography approach for your special day"
          icon={Video}
        />
      </div>
    </section>
