      ...
      <div className="min-h-screen py-16">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {/* Free Plan */}
            <Card className="relative backdrop-blur-sm bg-white/80 dark:bg-slate-900/80">
            ...
            {/* Pro Plan */}
            <Card className="relative border-primary backdrop-blur-sm bg-white/80 dark:bg-slate-900/80">
